...
@objc open class ExpandableLabel: UILabel {
    ...
    @IBInspectable open var shouldCollapse: Bool = true
...
//    
//    @discardableResult func boldText(_ text: String, size: CGFloat, color: UIColor) -> NSAttributedString {
//        let titleAttributes: [NSAttributedString.Key: Any] = [
//            NSAttributedString.Key.font: fontMedium(size),
//            NSAttributedString.Key.foregroundColor: color]
//        let attrString = NSAttributedString(string:text, attributes: titleAttributes)
//        return attrString
//    }
//    
//}
